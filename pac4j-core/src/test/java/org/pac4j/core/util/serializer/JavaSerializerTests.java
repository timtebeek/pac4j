 ...
 * @since 1.8.1
 */
final class JavaSerializerTests implements TestsConstants {
    ...
    @Test
    void testBytesSerializationUnsecure() {
    ...
    @Test
    void testBytesSerializationTrustedClass() {
        var h = new JavaSerializer();
        h.clearTrustedPackages();
        h.clearTrustedClasses();
    ...
    @Test
    void testTrustedPackagesModification() {
    ...
    @Test
    void testBytesSerializationTrustedPackage() {
        var h = new JavaSerializer();
    ...
    @Test
    void testBase64StringSerialization() {
        val profile = getUserProfile();
        val serialized = helper.serializeToString(profile);
        UserProfile profile2 = (CommonProfile) helper.deserializeFromString(serialized);
        assertEquals(profile.getId(), profile2.getId());
    ...
    @Test
    void testFoundActionSerialization() {
