 ...
 * @since 1.0.0
 */
final class OidcRedirectTests implements TestsConstants {
    ...
    @Test
    void testAjaxRequestAfterStandardRequestShouldNotOverrideState() throws MalformedURLException, URISyntaxException {
