 ...
 * @since 1.9.2
 */
final class SecretEncryptionConfigurationTests implements TestsConstants {
    ...
    @Test
    void testEncryptDecryptPlainJWTBase64Secret() throws ParseException, JOSEException {
        val config = new SecretEncryptionConfiguration();
    ...
    @Test
    void testEncryptDecryptPlainJWTBytesSecret() throws ParseException, JOSEException {
        val config = new SecretEncryptionConfiguration();
