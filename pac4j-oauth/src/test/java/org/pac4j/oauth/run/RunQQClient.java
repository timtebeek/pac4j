...
//        System.setProperty("sun.security.ssl.allowUnsafeRenegotiation", "true");
        val runQQClient = new RunQQClient();
        runQQClient.run();
    }
    ...
    protected IndirectClient getClient() {
        val qqClient = new QQClient();
        val apiKey = "101481951";
        val apiSecret = "60e9b925304a223403c7342efffcfa76";
    ...
    protected void verifyProfile(CommonProfile userProfile) {
        val profile = (QQProfile) userProfile;
